  ...
  return (
    <section className="py-20 md:py-32 bg-gradient-to-b from-white via-gray-50 to-white relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center justify-center w-20 h-20 mb-8 rounded-2xl bg-gradient-to-br from-primary-100 to-secondary-100">
          ...
          <p className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 max-w-3xl mx-auto">
        ...
        <motion.div
          ...
          className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-24 md:mb-32"
        >
          {stats.map((stat, index) => (
            ...
            >
              {/* Number */}
              <div className="text-6xl md:text-7xl lg:text-8xl font-black mb-2 transition-all duration-300">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent mb-24 md:mb-32"
        />
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <h3 className="text-3xl md:text-5xl font-bold text-center text-gray-900 mb-16">
            How We{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-600">
              Transform
            </span>
            ...
            {[
              {
                num: "01",
                title: "Assess",
                desc: "Deep-dive into your infrastructure. Identify critical bottlenecks and risks.",
              },
              {
                num: "02",
                title: "Transform",
                desc: "Deploy battle-tested DevOps and Kubernetes frameworks. No guesswork.",
              },
              {
                num: "03",
                title: "Empower",
                desc: "Transfer knowledge. Your team owns the system with confidence.",
              },
              {
                num: "04",
                title: "Scale",
                desc: "Systems that grow with you. Resilient, efficient, ready for anything.",
              },
            ].map((step, index) => (
              <motion.div
                key={index}
                ...
                className="relative bg-white p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-xl transition-all cursor-pointer group"
              >
                <div className="absolute -top-4 -left-4 w-12 h-12 rounded-xl bg-gradient-to-br from-primary-600 to-secondary-600 flex items-center justify-center text-white font-bold shadow-lg">
                  {step.num}
                </div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-primary-600 to-primary-700 rounded-3xl p-10 md:p-16 text-white relative overflow-hidden"
        >
          ...
          <div className="relative">
            ...
            <p className="text-xl md:text-2xl font-semibold text-center mb-12 opacity-90">
