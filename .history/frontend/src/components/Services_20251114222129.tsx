        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl border border-gray-200 hover:border-primary-300 hover:shadow-xl transition-all duration-300 group"
              >
