    ...
    <main className="min-h-screen">
      ...
      <section id="open-positions" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <div className="flex flex-col h-full">
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <button className="w-full flex items-center justify-center gap-2 py-2 px-4 bg-gradient-to-r from-primary-600 to-secondary-600 text-white font-semibold rounded-lg group-hover:shadow-md transition-all">
                      View Details
                      <ArrowRight size={18} />
                    </button>
                  </div>
          ...
          >
            <div className="inline-block bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 md:p-12">
